  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-10 px-10 py-5">
        <div>
          <h1 className="text-xl font-bold">Deduction Log</h1>
          <div className="w-full">
            <h1 className="text-sm text-gray-500">29 April 2024</h1>
            <div className="flex justify-between bg-gray-100 rounded-lg px-5 py-5">
              <h1 className="text-xl text-gray-500">09:30 - 18:00</h1>
        ...
        <div className="w-full">
          <div className="flex justify-between bg-indigo-500 rounded-lg px-5 py-5">
            <h1 className="text-xl text-white">Total Deduction</h1>
            <h1 className="font-bold text-white">Rp. 50.000, 00.-</h1>
          </div>
        </div>
      </div>
    </>
