...
exports.createEmployeeService = exports.updateLeaveRequest = void 0;
        ...
        const dates = [
            {
                ...
                clockin: findEmployee === null || findEmployee === void 0 ? void 0 : findEmployee.shift.start,
                clockout: findEmployee === null || findEmployee === void 0 ? void 0 : findEmployee.shift.end,
...
const createEmployeeService = ({ email, fullname, password, positionId, shiftId, address, }) => __awaiter(void 0, void 0, void 0, function* () {
